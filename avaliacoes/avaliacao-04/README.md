# ATIVIDADE 4
### DESCRIÇÃO:
- Criar programa simulando um dispositivo IOT(Cliente) que monitora um servidor de temperatura e a cada 10 segundos envia a informação de temperatura para um servidor.
